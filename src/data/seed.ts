...
export const seed: Data = {
  ...
  events: [
    ...
    },
    {
      ...
      title: "Club de lecture des 10–14 ans",
      description:
        "Un livre par mois, choisi par les jeunes, discuté autour d’un chocolat chaud. Les parents peuvent rester ou profiter du café à côté. Rencontre fictive.",
      date: "2026-09-24",
      time: "16:00",
      location: "Laval · Bibliothèque Multiculturelle",
      organizer: "Fatima — membre (fictif)",
      age: "10–14 ans",
      published: true,
      region: "Laval et Rive-Nord",
      price: "Gratuit",
