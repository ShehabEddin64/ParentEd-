...
- Derniers ajustements : lueur retirée derrière la scène, personnages agrandis et disposés sur deux plans (deux derrière la colline avant), points centrés, fonds alternés (blanc, vert pâle, blanc, bleu pâle, blanc, crème), bouton FR / EN avec traduction anglaise complète de la page publique (`src/landing-text.ts`), choix mémorisé et `lang` du document mis à jour. L’espace membre et les mentions légales restent en français.
